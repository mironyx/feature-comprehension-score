...
// integration level, but did not assert that the service layer threads the field
// through to the RPC call argument in the unit-test path.
// ---------------------------------------------------------------------------

describe('createFcs — comprehension_depth RPC wiring', () => {
