...
-- finalise_rubric_v3: extends v2 with rubric-generation observability
-- (token counts, tool-call log, wall-clock duration). E11 quality fields
-- remain nullable to permit cross-epic ordering.
-- ADR-0023, LLD §17.1d.
