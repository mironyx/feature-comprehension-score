alter table "public"."assessments" add column "rubric_progress" text;

alter table "public"."assessments" add column "rubric_progress_updated_at" timestamp with time zone;
