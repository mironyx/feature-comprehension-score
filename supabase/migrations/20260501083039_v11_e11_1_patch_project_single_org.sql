drop function if exists "public"."patch_project"(p_project_id uuid, p_org_ids uuid[], p_project_fields jsonb, p_context_fields jsonb);

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.patch_project(p_project_id uuid, p_org_id uuid, p_project_fields jsonb, p_context_fields jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
